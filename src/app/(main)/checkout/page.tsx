...
export default function CheckoutPage() {
  ...
  // if (id) {
  //   cartItems.push({ id, quantity: parseInt(qty || "1") });
  // } else {
        ...
        <div className="lg:col-span-5 bg-zinc-900 rounded-2xl border border-zinc-800 p-6 space-y-4">
          ...
          <div className="pt-4 space-y-2">
            ...
            <div className="flex justify-between text-sm text-zinc-400">
              <span>Delivery</span>
              <div>
                <div>Inside Dhaka ৳60</div>
                <div>Outside Dhaka ৳120</div>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <button
                  ...
                  className={`relative flex flex-col p-3 rounded-2xl border-2 ${
                    location === opt.val
                      ? "border-[#2fa83e] bg-[#2fa83e]/10"
                ...
                >
                  <opt.icon
                    size={22}
                    className={`mb-2 ${
                      location === opt.val ? "text-green-400" : "text-zinc-400"
                    }`}
                  />
                  <span className="font-bold">{opt.title}</span>
                  <span className="text-sm text-zinc-400">{opt.sub}</span>
                  <span className="mt-2 font-bold">{opt.price}</span>
                </button>
              ))}
            </div> */}
